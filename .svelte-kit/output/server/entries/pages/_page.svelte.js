import { c as create_ssr_component, a as add_attribute, e as escape, o as onDestroy, v as validate_component, i as each } from "../../chunks/ssr.js";
...
const css = {
  code: ".snap-x.svelte-11r6qst{scrollbar-width:none;-ms-overflow-style:none}.snap-x.svelte-11r6qst::-webkit-scrollbar{display:none}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="container h-full mx-auto flex justify-center items-center"><div class="text-center flex flex-col items-center"><h2 class="h2" data-svelte-h="svelte-kyb6as">Welcome to Life@IIIT-H</h2> <div class="grid grid-cols-[auto_1fr_auto] gap-4 items-center"> <button type="button" class="btn-icon variant-filled">${validate_component(Fa, "Fa").$$render($$result, { icon: faArrowLeft }, {}, {})}</button>  <div class="snap-x snap-mandatory scroll-smooth flex overflow-x-auto svelte-11r6qst"${add_attribute("this", elemCarousel, 0)}>${each(Array.from({ length: 12 }, (_, i) => i + 1), (photo) => {
    return `<img class="snap-center w-[1024px] rounded-container-token"${add_attribute("src", `${base}/carousel/${photo}.jpg`, 0)}${add_attribute("alt", `carousel-${photo}`, 0)} loading="lazy">`;
  })}</div>  <button type="button" class="btn-icon variant-filled">${validate_component(Fa, "Fa").$$render($$result, { icon: faArrowRight }, {}, {})}</button></div></div> </div>`;
});
export {
  Page as default
};
