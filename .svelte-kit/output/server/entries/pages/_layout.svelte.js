...
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  getDrawerStore();
  return `<nav class="list-nav p-4"><ul><li><a href="/" data-svelte-h="svelte-ck97ip">Home</a></li> <li><a href="/committee" data-svelte-h="svelte-epduia">Committee</a></li> <li><a href="/student-bodies" data-svelte-h="svelte-19u50o1">Student Bodies</a></li> <li><a href="/calendar" data-svelte-h="svelte-1nwc480">Calendar</a></li> ${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}</ul></nav>`;
});
const css$1 = {
  code: ".inline-list.svelte-1d5svs.svelte-1d5svs{list-style:none;padding:0;margin:0;display:flex;gap:10px}.inline-list.svelte-1d5svs li.svelte-1d5svs{display:inline}.inline-list-footer.svelte-1d5svs.svelte-1d5svs{list-style:none;padding:0;margin:0;display:flex;align-items:center;justify-content:center;flex-direction:column;text-align:center}@media(max-width: 1024px){.inline-list.svelte-1d5svs.svelte-1d5svs{display:none}}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${validate_component(Drawer, "Drawer").$$render($$result, {}, {}, {
    default: () => {
      return `<h2 class="p-4" data-svelte-h="svelte-dhm0r2">Navigation</h2> <hr> ${validate_component(Navigation, "Navigation").$$render($$result, {}, {}, {})}`;
    }
  })} ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    pageFooter: () => {
      return `<div data-svelte-h="svelte-1darpz8"><style lang="postcss"></style> <ul class="inline-list-footer svelte-1d5svs"><li><p>© 2021-2024, IIIT Hyderabad</p></li> <li><p>Made Developed &amp; Maintained with ❤️ by SLC Tech Team (powered by Clubs Council)</p></li></ul></div> `;
    },
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `<div><ul class="inline-list svelte-1d5svs"><li class="svelte-1d5svs" data-svelte-h="svelte-imthhm"><a class="btn btn-sm variant-ghost-surface" href="/">Home</a></li> <li class="svelte-1d5svs" data-svelte-h="svelte-yz6igd"><a class="btn btn-sm variant-ghost-surface" href="/committee">Committee</a></li> <li class="svelte-1d5svs" data-svelte-h="svelte-5exdz9"><a class="btn btn-sm variant-ghost-surface" href="/student-bodies">Student Bodies</a></li> <li class="svelte-1d5svs" data-svelte-h="svelte-8uj6md"><a class="btn btn-sm variant-ghost-surface" href="/calendar">Calendar</a></li> <li class="svelte-1d5svs">${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}</li></ul></div> `;
        },
        lead: () => {
          return `<button class="lg:hidden btn btn-sm mr-4" data-svelte-h="svelte-gmbepc"><span><svg viewBox="0 0 100 80" class="fill-token w-4 h-4"><rect width="100" height="20"></rect><rect y="30" width="100" height="20"></rect><rect y="60" width="100" height="20"></rect></svg></span></button> <img${add_attribute("src", `${base}/life-iiit.png`, 0)} alt="IIIT Hyderabad Logo" class="h-12"> `;
        },
        default: () => {
          return `<script data-svelte-h="svelte-1yh50qz"><\/script>`;
        }
      })} `;
    },
    default: () => {
