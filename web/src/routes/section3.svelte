                ...
                <div class="card__wrap text-white">
                    ...
                    <div class="card__post">
                        <div class="image__post">
                            <img src="https://clubs.iiit.ac.in/_next/image?url=http%3A%2F%2Ffiles%2Ffiles%2Fdownload%3Ffilename%3DVAMzZaAoNDSYWgKVThya2u_bhav.beri.jpg&w=640&q=75" alt="">
                        </div>
            ...
            <div class="col-lg-4 col-md-6 wrap">
                <div class="card__wrap text-white">
                    ...
                    <div class="card__post">
                        ...
                        <div class="author__post">
                            <p class="author mbr-fonts-style display-4">Posted by <strong>admin</strong></p>
                            <p class="date mbr-fonts-style display-4">May 24, 2024</p>
                        </div>
                    </div>
                    <div class="card__content" >
                        <!-- <div class="card__topic">
